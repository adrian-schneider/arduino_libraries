...
*********************************************************************/
#ifndef _Adafruit_mPCD8544_H
#define _Adafruit_mPCD8544_H
...
class Adafruit_mPCD8544 : public Adafruit_mGFX {
 public:
  // Software SPI with explicit CS pin.
  Adafruit_mPCD8544(int8_t SCLK, int8_t DIN, int8_t DC, int8_t CS, int8_t RST);
  // Software SPI with CS tied to ground.  Saves a pin but other pins can't be shared with other hardware.
  Adafruit_mPCD8544(int8_t SCLK, int8_t DIN, int8_t DC, int8_t RST);
  ...
  Adafruit_mPCD8544(int8_t DC, int8_t CS, int8_t RST);
